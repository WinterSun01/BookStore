...
namespace BookStore.Data.Migrations
{
    ...
    [Migration("20260703201548_RemoveRequiredFromLastName")]
    partial class RemoveRequiredFromLastName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArticleBook", b =>
                {
                    ...
                    b.HasKey("ArticlesId", "BooksId");

                    b.HasIndex("BooksId");

                    b.ToTable("ArticleBooks", (string)null);
                });
            ...
            modelBuilder.Entity("BookStore.Models.Entities.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Models.Entities.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Models.Entities.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArticleBook", b =>
                {
                    b.HasOne("BookStore.Models.Entities.Article", null)
                        .WithMany()
                        .HasForeignKey("ArticlesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStore.Models.Entities.Book", null)
                        .WithMany()
